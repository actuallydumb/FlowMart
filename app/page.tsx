        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-2xl font-bold">WorkflowKart</h4>
              </div>
              <p className="text-muted-foreground mb-4 max-w-md">
                The ultimate marketplace for automation workflows. Build, buy,
                and automate your business processes with ease.
              </p>
              <div className="flex space-x-4">
                <Button variant="ghost" size="sm" asChild>
                  <Link href="https://twitter.com/workflowkart">
                    <Twitter className="h-4 w-4" />
                  </Link>
                </Button>
                <Button variant="ghost" size="sm" asChild>
                  <Link href="https://linkedin.com/company/workflowkart">
                    <Linkedin className="h-4 w-4" />
                  </Link>
                </Button>
                <Button variant="ghost" size="sm" asChild>
                  <Link href="https://github.com/workflowkart">
          ...
          <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-muted-foreground text-sm">
              © 2024 WorkflowKart. All rights reserved.
            </p>
